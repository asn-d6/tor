...
rep_hist_format_hs_stats(time_t now, bool is_v3)
{
  ...
  tor_asprintf(&hs_stats_string, "%s %s (%d s)\n"
               ...
               is_v3 ? "hidserv-rend-v3-relayed-cells-unobfuscated" : "hidserv-rend-relayed-cells-unobfuscated",
               rp_cells_seen,
               is_v3 ?
               ...
               is_v3 ? "hidserv-dir-v3-onions-seen-unobfuscated" : "hidserv-dir-onions-seen-unobfuscated",
               onions_seen,
...
rep_hist_hs_stats_write(time_t now, bool is_v3)
{
  ...
  if (!check_or_create_data_subdir("stats")) {
    ...
    tor_asprintf(&perma_fname,
                 is_v3 ? "hidserv-v3-stats-%s" : "hidserv-stats-%s",
                 formatted_time);
