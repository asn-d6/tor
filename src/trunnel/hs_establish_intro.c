/* hs_establish_intro.c -- generated by Trunnel v1.4.4.
...
int hsestablishintro_deadcode_dummy__ = 0;
#define OR_DEADCODE_DUMMY || hsestablishintro_deadcode_dummy__
#else
...
hs_establish_intro_cell_t *
hs_establish_intro_cell_new(void)
{
  hs_establish_intro_cell_t *val = trunnel_calloc(1, sizeof(hs_establish_intro_cell_t));
  if (NULL == val)
    return NULL;
  return val;
}
 ...
 */
static void
hs_establish_intro_cell_clear(hs_establish_intro_cell_t *obj)
{
  (void) obj;
...
void
hs_establish_intro_cell_free(hs_establish_intro_cell_t *obj)
{
  if (obj == NULL)
    return;
  hs_establish_intro_cell_clear(obj);
  trunnel_memwipe(obj, sizeof(hs_establish_intro_cell_t));
  trunnel_free_(obj);
}

const uint8_t *
hs_establish_intro_cell_get_start_cell(const hs_establish_intro_cell_t *inp)
{
  return inp->start_cell;
}
uint8_t
hs_establish_intro_cell_get_auth_key_type(hs_establish_intro_cell_t *inp)
{
  return inp->auth_key_type;
}
int
hs_establish_intro_cell_set_auth_key_type(hs_establish_intro_cell_t *inp, uint8_t val)
{
  inp->auth_key_type = val;
  return 0;
}
uint16_t
hs_establish_intro_cell_get_auth_key_len(hs_establish_intro_cell_t *inp)
{
  return inp->auth_key_len;
}
int
hs_establish_intro_cell_set_auth_key_len(hs_establish_intro_cell_t *inp, uint16_t val)
{
  inp->auth_key_len = val;
  return 0;
}
size_t
hs_establish_intro_cell_getlen_auth_key(const hs_establish_intro_cell_t *inp)
{
  return TRUNNEL_DYNARRAY_LEN(&inp->auth_key);
}

uint8_t
hs_establish_intro_cell_get_auth_key(hs_establish_intro_cell_t *inp, size_t idx)
{
  return TRUNNEL_DYNARRAY_GET(&inp->auth_key, idx);
}

int
hs_establish_intro_cell_set_auth_key(hs_establish_intro_cell_t *inp, size_t idx, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->auth_key, idx, elt);
  return 0;
}
int
hs_establish_intro_cell_add_auth_key(hs_establish_intro_cell_t *inp, uint8_t elt)
{
...
uint8_t *
hs_establish_intro_cell_getarray_auth_key(hs_establish_intro_cell_t *inp)
{
  return inp->auth_key.elts_;
}
int
hs_establish_intro_cell_setlen_auth_key(hs_establish_intro_cell_t *inp, size_t newlen)
{
  uint8_t *newptr;
...
uint8_t
hs_establish_intro_cell_get_n_extensions(hs_establish_intro_cell_t *inp)
{
  return inp->n_extensions;
}
int
hs_establish_intro_cell_set_n_extensions(hs_establish_intro_cell_t *inp, uint8_t val)
{
  inp->n_extensions = val;
  return 0;
}
size_t
hs_establish_intro_cell_getlen_extensions(const hs_establish_intro_cell_t *inp)
{
  return TRUNNEL_DYNARRAY_LEN(&inp->extensions);
}

struct extension_st *
hs_establish_intro_cell_get_extensions(hs_establish_intro_cell_t *inp, size_t idx)
{
  return TRUNNEL_DYNARRAY_GET(&inp->extensions, idx);
}

int
hs_establish_intro_cell_set_extensions(hs_establish_intro_cell_t *inp, size_t idx, struct extension_st * elt)
{
  extension_t *oldval = TRUNNEL_DYNARRAY_GET(&inp->extensions, idx);
  if (oldval && oldval != elt)
    extension_free(oldval);
  return hs_establish_intro_cell_set0_extensions(inp, idx, elt);
}
int
hs_establish_intro_cell_set0_extensions(hs_establish_intro_cell_t *inp, size_t idx, struct extension_st * elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->extensions, idx, elt);
  return 0;
}
int
hs_establish_intro_cell_add_extensions(hs_establish_intro_cell_t *inp, struct extension_st * elt)
{
#if SIZE_MAX >= UINT8_MAX
...
struct extension_st * *
hs_establish_intro_cell_getarray_extensions(hs_establish_intro_cell_t *inp)
{
  return inp->extensions.elts_;
}
int
hs_establish_intro_cell_setlen_extensions(hs_establish_intro_cell_t *inp, size_t newlen)
{
...
const uint8_t *
hs_establish_intro_cell_get_end_mac_fields(const hs_establish_intro_cell_t *inp)
{
  return inp->end_mac_fields;
}
size_t
hs_establish_intro_cell_getlen_handshake_sha3_256(const hs_establish_intro_cell_t *inp)
{
  (void)inp;  return SHA3_256_MAC_LEN;
}

uint8_t
hs_establish_intro_cell_get_handshake_sha3_256(const hs_establish_intro_cell_t *inp, size_t idx)
{
...
int
hs_establish_intro_cell_set_handshake_sha3_256(hs_establish_intro_cell_t *inp, size_t idx, uint8_t elt)
{
  trunnel_assert(idx < SHA3_256_MAC_LEN);
...
uint8_t *
hs_establish_intro_cell_getarray_handshake_sha3_256(hs_establish_intro_cell_t *inp)
{
  return inp->handshake_sha3_256;
}
uint16_t
hs_establish_intro_cell_get_siglen(hs_establish_intro_cell_t *inp)
{
  return inp->siglen;
}
int
hs_establish_intro_cell_set_siglen(hs_establish_intro_cell_t *inp, uint16_t val)
{
  inp->siglen = val;
  return 0;
}
const uint8_t *
hs_establish_intro_cell_get_end_sig_fields(const hs_establish_intro_cell_t *inp)
{
  return inp->end_sig_fields;
}
size_t
hs_establish_intro_cell_getlen_sig(const hs_establish_intro_cell_t *inp)
{
  return TRUNNEL_DYNARRAY_LEN(&inp->sig);
}

uint8_t
hs_establish_intro_cell_get_sig(hs_establish_intro_cell_t *inp, size_t idx)
{
  return TRUNNEL_DYNARRAY_GET(&inp->sig, idx);
}

int
hs_establish_intro_cell_set_sig(hs_establish_intro_cell_t *inp, size_t idx, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->sig, idx, elt);
  return 0;
}
int
hs_establish_intro_cell_add_sig(hs_establish_intro_cell_t *inp, uint8_t elt)
{
#if SIZE_MAX >= UINT16_MAX
...
uint8_t *
hs_establish_intro_cell_getarray_sig(hs_establish_intro_cell_t *inp)
{
  return inp->sig.elts_;
}
int
hs_establish_intro_cell_setlen_sig(hs_establish_intro_cell_t *inp, size_t newlen)
{
  uint8_t *newptr;
#if UINT16_MAX < SIZE_MAX
  if (newlen > UINT16_MAX)
...
const char *
hs_establish_intro_cell_check(const hs_establish_intro_cell_t *obj)
{
  if (obj == NULL)
    return "Object was NULL";
  if (obj->trunnel_error_code_)
...
ssize_t
hs_establish_intro_cell_encoded_len(const hs_establish_intro_cell_t *obj)
{
  ssize_t result = 0;

  if (NULL != hs_establish_intro_cell_check(obj))
     return -1;
...
int
hs_establish_intro_cell_clear_errors(hs_establish_intro_cell_t *obj)
{
  int r = obj->trunnel_error_code_;
  obj->trunnel_error_code_ = 0;
  return r;
...
ssize_t
hs_establish_intro_cell_encode(uint8_t *output, const size_t avail, const hs_establish_intro_cell_t *obj)
{
  ssize_t result = 0;
  size_t written = 0;
  uint8_t *ptr = output;
  const char *msg;
#ifdef TRUNNEL_CHECK_ENCODED_LEN
  const ssize_t encoded_len = hs_establish_intro_cell_encoded_len(obj);
#endif

  if (NULL != (msg = hs_establish_intro_cell_check(obj)))
    goto check_failed;
...
/** As hs_establish_intro_cell_parse(), but do not allocate the output
 * object.
 */
static ssize_t
hs_establish_intro_cell_parse_into(hs_establish_intro_cell_t *obj, const uint8_t *input, const size_t len_in)
{
  const uint8_t *ptr = input;
  size_t remaining = len_in;
  ssize_t result = 0;
...
ssize_t
hs_establish_intro_cell_parse(hs_establish_intro_cell_t **output, const uint8_t *input, const size_t len_in)
{
  ssize_t result;
  *output = hs_establish_intro_cell_new();
  if (NULL == *output)
    return -1;
  result = hs_establish_intro_cell_parse_into(*output, input, len_in);
  if (result < 0) {
    hs_establish_intro_cell_free(*output);
    *output = NULL;
  }
  return result;
}
