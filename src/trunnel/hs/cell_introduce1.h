/* cell_introduce1.h -- generated by by Trunnel v1.4.6.
 ...
 */
uint8_t hs_cell_introduce1_get_legacy_key_id(const hs_cell_introduce1_t *inp, size_t idx);
 ...
 */
uint8_t hs_cell_introduce_encrypted_get_rend_cookie(const hs_cell_introduce_encrypted_t *inp, size_t idx);
/** Change the element at position 'idx' of the fixed array field
