/* cell_establish_intro.h -- generated by by Trunnel v1.4.5.
...
/** Return the position for start_mac_data when we parsed this object
 */
const uint8_t * hs_cell_establish_intro_get_start_mac_data(const hs_cell_establish_intro_t *inp);
...
/** Return the position for end_mac_data when we parsed this object
 */
const uint8_t * hs_cell_establish_intro_get_end_mac_data(const hs_cell_establish_intro_t *inp);
 ...
 */
uint8_t hs_cell_establish_intro_get_handshake_mac(const hs_cell_establish_intro_t *inp, size_t idx);
