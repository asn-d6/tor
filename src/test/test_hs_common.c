...
typedef struct reachability_cfg_t {
   ...
   * hs_in_new_time_period() and test the returned value against this. */
...
run_reachability_scenario(const reachability_cfg_t *cfg, int num_scenario)
{
  ...
  tt_int_op(hs_in_new_time_period(mock_service_ns, 0), OP_EQ,
            cfg->service_in_new_tp);
  tt_int_op(hs_in_new_time_period(mock_client_ns, 0), OP_EQ,
