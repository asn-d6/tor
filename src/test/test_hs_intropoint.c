...
test_establish_intro_wrong_purpose(void *arg)
{
  ...
  /* Receive the cell */
  retval = hs_received_establish_intro(intro_circ, cell_body, cell_len);
  tt_int_op(retval, ==, -1);
...
test_establish_intro_wrong_keytype(void *arg)
{
  ...
  retval = hs_received_establish_intro(intro_circ, (uint8_t*)"", 0);
  tt_int_op(retval, ==, -1);
...
helper_establish_intro_v2(or_circuit_t *intro_circ)
{
  ...
  retval = hs_received_establish_intro(intro_circ,
                                       cell_body, cell_len);
  tt_int_op(retval, ==, 0);
