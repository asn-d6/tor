 ...
 *
 * \brief Manage the hidden service circuitmap: A hash table that maps
 * introduction and rendezvous tokens to introduction and rendezvous circuits.
 **/
...
/* Query circuitmap for circuit with <b>token</b>. Return NULL if no such
   circuit is found. */
static or_circuit_t *
