...
typedef struct hs_service_intro_point_t {
   ...
   * the the base object legacy flag is set. */
...
STATIC hs_service_intro_point_t *service_intro_point_new(void);
...
STATIC hs_service_descriptor_t *service_desc_find_by_intro(
                                         ...
                                         const hs_service_intro_point_t *ip);
/* Helper functions. */
STATIC void get_objects_from_ident(hs_circ_identifier_t *ident,
...
STATIC int intro_point_should_expire(const hs_service_intro_point_t *ip,
                                     time_t now);
STATIC void run_service_event(time_t now);
