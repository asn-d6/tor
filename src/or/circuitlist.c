...
/**
 * A cached value of the current state of the origin circuit list.
 * Has the value 1 if we saw any opened circuits recently. 0 otherwise.
 */
static int any_opened_circs = 0;
...
{
  any_opened_circs = circuits_are_opened;
}
