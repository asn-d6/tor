...
/** Return the string that tor should place in
 *  TOR_PT_SERVER_TRANSPORT_OPTIONS while configuring the server
 *  manged proxy in <b>mp</b>. The string is stored in the heap, and
 *  it's the the responsibility of the caller to deallocate it after
 *  its use. */
static char *
