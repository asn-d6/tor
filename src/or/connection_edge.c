 ...
 * setup the connection, attach it to the circ and connect it. Return 0 on
 * success or END_CIRC_AT_ORIGIN if we can't find the requested hidden service
 * port where the caller should close the circuit. */
static int
