                                       ...
                                       hs_cell_establish_intro_t *cell)
{
  ...
  uint8_t *key_array = hs_cell_establish_intro_getarray_auth_key(cell);
                            ...
                            size_t circuit_key_material_len)
{
  ...
  /* Verify the MAC */
  const char *msg = (char*) cell->start_mac_data;
  const size_t auth_msg_len = (char*) (cell->end_mac_data) - msg;
                                     ...
                                     hs_cell_establish_intro_t *parsed_cell)
{
  ...
  /* Then repurpose this circuit into an intro circuit. */
                       ...
                       size_t request_len)
{
  ...
  /* Parse the cell */
  ssize_t parsing_result = hs_cell_establish_intro_parse(&parsed_cell, request, request_len);
  if (parsing_result < 0) {
